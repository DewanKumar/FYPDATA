...
with open("czone_10_11_2024.json", "r", encoding="utf-8") as f1, open("czone_03_11_2024.json", "r", encoding="utf-8") as f2:
...
if price_increases:
    ...
    df.to_csv("price_increased_report.csv", index=False)
    print("✅ Price increases saved to 'price_increased_report.csv'")
else:
