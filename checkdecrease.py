...
with open("paklap_01_12_2024.json", "r", encoding="utf-8") as f1, open("paklap_24_11_2024.json", "r", encoding="utf-8") as f2:
...
if price_decreases:
    ...
    df.to_csv("price_decreased_paklap.csv", index=False)
    print("✅ Price decreases saved to 'price_decreased_paklap.csv'")
else:
